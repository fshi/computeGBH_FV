...
class descFeature
{
	...
	bool				_2chnls;		//for true, it has "mbhx + mbhy" or "hog+hme" or "hog+hof". otherwise, it has "mbhx // mbhy" or "hog // hme" or "hog // hof"
...
public:
	...
	{
		return _2chnls?(_feaSz/2 - _rtSz):(_feaSz - _rtSz);
	}
